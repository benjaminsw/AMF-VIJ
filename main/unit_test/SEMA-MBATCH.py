...
def train_sequential_amf_vi(dataset_name='multimodal', flow_types=None, show_plots=True, save_plots=False, n_samples=100_000, tau=1.1, beta=1e-5, M=3):
    ...
    print(f"🚀 Sequential AMF-VI v2.5.0 (τ={tau} | β={beta} | M={M} | SEMA-MBATCH) on {dataset_name}")
    print("=" * 60)
    ...
    with torch.no_grad():
        ...
        plt.tight_layout()
        plt.suptitle(f'AMF-VI v2.5.0 (τ={tau} | β={beta} | M={M} | SEMA-MBATCH) — {dataset_name.title()}', fontsize=16)
    ...
    with open(model_path, 'wb') as f:
        pickle.dump({
            ...
            'tau': tau,
            'beta': beta,
            'M': M,                               # v2.5.0: log M for traceability
            'version': '2.5.0',                   # v2.5.0: version tracking
            'abbr': 'AMFVI-SEMA-MBATCH',          # v2.5.0: abbr tracking
...
if __name__ == "__main__":
    ...
    print(f"🚀 AMF-VI v2.5.0 | flows={flow_types} | τ={TAU} | β={BETA} | M={M} | SEMA-MBATCH")
