...
def train_sequential_amf_vi(dataset_name='multimodal', flow_types=None, show_plots=True, save_plots=False, n_samples=100_000, tau=1.1):
    ...
    print(f"🚀 Sequential AMF-VI v2.2.0 (τ={tau} | SEMA-PRIOR) on {dataset_name}")
    print("=" * 60)
    ...
    with torch.no_grad():
        ...
        plt.tight_layout()
        plt.suptitle(f'AMF-VI v2.2.0 (τ={tau} | SEMA-PRIOR) — {dataset_name.title()}', fontsize=16)
    ...
    with open(model_path, 'wb') as f:
        pickle.dump({
            ...
            'tau': tau,
            'version': '2.2.0',                  # v2.2.0: version tracking
            'abbr': 'AMFVI-SEMA-PRIOR',           # v2.2.0: abbr tracking
...
if __name__ == "__main__":
    ...
    print(f"🚀 AMF-VI v2.2.0 | flows={flow_types} | τ={TAU} | SEMA-PRIOR")
